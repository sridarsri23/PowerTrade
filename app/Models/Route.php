...
namespace dtc\Models {
	...
	class Route extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'code', 'created_at', 'updated_on', 'updated_at', 'is_deleted', 'name');
        ...
        {
            return $this->hasMany('dtc\Models\Outlet');
        }
