...
namespace dtc\Models {
	...
	class DriverPayment extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'note', 'amount', 'created_at', 'updated_on', 'updated_at', 'date','code','driver_id','sales_id');
