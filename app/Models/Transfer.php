...
namespace dtc\Models {
	...
	class Transfer extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'lkr', 'sdr', 'date', 'from_agent_id', 'code', 'created_at', 'updated_on', 'updated_at', 'note', 'from_agnt_pha', 'to_agent_pha', 'to_agent_id');
