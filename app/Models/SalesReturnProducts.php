...
namespace dtc\Models {
	...
	class SalesReturnProducts extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

        protected $fillable = array('id', 'sales_return_id',  'product_id', 'price','qty');
