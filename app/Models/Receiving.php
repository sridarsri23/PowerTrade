...
namespace dtc\Models {
	...
	class Receiving extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'lkr', 'sdr', 'date', 'currency', 'agent_id', 'code', 'created_at', 'updated_on', 'updated_at', 'note', 'kooli', 'rate', 'pcapital','currency_amount');
