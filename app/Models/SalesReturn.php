...
namespace dtc\Models {
	...
	class SalesReturn extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;
        protected $fillable = array('id', 'code',  'created_at', 'updated_on', 'updated_at', 'is_deleted', 'invoice_no', 'note', 'date','sales_id','outlet_id','total','total_payable','is_resellable','is_sold');
