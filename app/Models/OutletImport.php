...
namespace dtc\Models {
	...
	class OutletImport extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('name', 'email', 'phone', 'created_at', 'updated_on', 'updated_at', 'address', 'note','credit','cheque');
