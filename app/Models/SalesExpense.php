...
namespace dtc\Models {
	...
	class SalesExpense extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'note', 'amount', 'type', 'created_at', 'updated_on', 'updated_at', 'date','code','sales_id');
