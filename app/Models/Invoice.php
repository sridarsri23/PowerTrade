...
namespace dtc\Models {
	...
	class Invoice extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;
        protected $fillable = array('id', 'code',  'created_at', 'updated_on', 'updated_at', 'is_deleted', 'invoice_no', 'note', 'cash', 'cheque_value', 'credit', 'cheque_date', 'cheque_bank','date','sales_id','outlet_id','cheque_no','total','previous_credit','previous_cheque','total_payable','is_settled','discount','is_outlet_deleted', 'is_sales_deleted');
