...
namespace dtc\Models {
	...
	class Sales extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;
        protected $fillable = array('id', 'code',  'created_at', 'updated_on', 'updated_at', 'is_deleted', 'lorry_id', 'driver_id', 'salesman_id', 'route_id','start_date','end_date');
