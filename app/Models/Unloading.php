...
namespace dtc\Models {
	...
	class Unloading extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;
        protected $fillable = array('id', 'code',  'created_at', 'updated_on', 'updated_at', 'is_deleted', 'date', 'incharge_id', 'sales_id');
