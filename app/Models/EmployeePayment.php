...
namespace dtc\Models {
	...
	class EmployeePayment extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'note', 'amount', 'created_at', 'updated_on', 'updated_at', 'date','code','employee_id');
