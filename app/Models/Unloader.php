...
namespace dtc\Models {
	...
	class Unloader extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

        protected $fillable = array('id', 'sales_id',  'product_id', 'qty');
