...
namespace dtc\Models {
	...
	class SalesProducts extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

        protected $fillable = array('id', 'sales_id',  'product_id', 'cost_price');
