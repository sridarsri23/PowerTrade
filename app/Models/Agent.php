...
namespace dtc\Models {
	...
	class Agent extends Model implements AuthenticatableContract, CanResetPasswordContract{
		...
		protected $fillable = array('id', 'name', 'email', 'full_name', 'phone', 'created_at', 'updated_on', 'updated_at', 'is_deleted', 'address', 'code', 'note', 'amount', 'bank_acc_1', 'bank_acc_2', 'bank_acc_3', 'bank_acc_4','cmn_pcnt');
