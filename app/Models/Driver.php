...
namespace dtc\Models {
	...
	class Driver extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'name', 'email',  'phone', 'created_at', 'updated_on', 'updated_at', 'is_deleted', 'address', 'code', 'note');
