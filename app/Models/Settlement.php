...
namespace dtc\Models {
	...
	class Settlement extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'lkr', 'sdr', 'cmn', 'date', 'agent_bank_acc', 'agent_id', 'code', 'created_at', 'updated_on', 'updated_at', 'note','ismailed','maileddate','pha');
