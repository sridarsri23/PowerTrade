...
namespace dtc\Models {
	...
	class RunningExpense extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'note', 'amount', 'type', 'created_at', 'updated_on', 'updated_at', 'date','code');
		 ...
		 * @var string
		 */
		protected $table = 'running_expense';
