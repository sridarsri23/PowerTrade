...
namespace dtc\Models {
	...
	class Order extends Model implements AuthenticatableContract, CanResetPasswordContract{
		...
		protected $fillable = array('id', 'code', 'date', 'from_currency', 'currency_rate', 'to_currency', 'from_currency_amount', 'to_currency_amount', 'commission_pcnt', 'comission_amount', 'commision_amount_currency', 'created_at', 'updated_on', 'updated_at', 'status', 'is_paid_to_agent', 'agent_id', 'client_id', 'client_bank_acc', 'note', 'agent_bank_acc','settlement_id','is_credit');
