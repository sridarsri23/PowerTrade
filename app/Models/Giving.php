...
namespace dtc\Models {
	...
	class Giving extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'lkr', 'sdr', 'date', 'agent_bank_acc', 'agent_id', 'code', 'created_at', 'updated_on', 'updated_at', 'note','pha');
