...
namespace dtc\Models {
	...
	class Cheque extends Model implements AuthenticatableContract, CanResetPasswordContract{

		use Authenticatable, CanResetPassword;

		protected $fillable = array('id', 'cheque_no', 'cheque_value', 'cheque_date', 'cheque_bank', 'created_at', 'updated_on', 'updated_at', 'is_deleted','invoice_id');
