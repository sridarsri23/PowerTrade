...
@section('middle_right_DIV')
	<h4>Create New Invoice for {!! dtc\Models\Sales::where('id','=',$selected_sales_id)->first()['code'] !!}</h4>
	{!! Form::open(array('route' => 'invoice.store','files' => true,'name'=>'invoice_form','onsubmit'=>'return validateForm()')) !!}
	<ul class="form_UL">
