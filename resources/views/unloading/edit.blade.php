...
@section('middle_right_DIV')
	<h4>Edit Unloading</h4>
	{!! Form::open(array('route' => array('unloading.update', $unloading->id) ,'method' => 'PUT','files' => true)) !!}
	<ul class="form_UL">

		<li>

			{!! Form::label('sales_id', 'Sales') !!}
			{!!Form::select('sales_id', $sales,$unloading->sales_id,array('id'=>'sales_id','class' => 'form_element'))!!}
		</li>

		<li>
			{!! Form::label('code', 'Unloading Code') !!}
			{!! Form::text('code',$unloading->code,array('class' => 'form_element','readonly'=>'readonly','tabindex'=>'-1')) !!}
		</li>

		<li>
			{!! Form::label('incharge_id', 'Incharge') !!}
			{!!Form::select('incharge_id', $incharges,$unloading->incharge_id,array('id'=>'incharge_id','class' => 'form_element'))!!}
		</li>
		<li>
			{!! Form::label('date', 'Date') !!}
			{!! Form::text('date',$unloading->date,array('class' => 'form_element','id'=>'date')) !!}
		</li>
		...
		@foreach ($productList as $index => $product)
			...
			<li>
				...
				{!! Form::text($product->code,dtc\Models\Unloader::where('unloading_id','=',$unloading->id)->where('product_id','=',$product->id)->first()['qty'] ,array('class' => 'form_element','id'=>$product->code)) !!}
		...
		<li>
			<a href="{!!URL::to('unloading')!!}" class="btn" tabindex = "-1">Back</a>
	...
	<script>
        ...
        $("#sales_id").change(function(){
            ...
            var outlet_code = <?php echo json_encode($unloading->code); ?>;
        ...
        $( document ).ready(function() {
            ...
            current_loading_code = <?php echo json_encode($unloading->code); ?>;
            //alert(outlet_code);
        });
