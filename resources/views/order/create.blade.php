...
@section('middle_right_DIV')
			...
			<h4>Create Order</h4>
		{!! Form::open(array('route' => 'order.store','files' => true)) !!}
		<ul class="form_UL">
			...
			<script src="{!!URL::to('js/chosen_old.jquery.js')!!}" type="text/javascript"></script>
...
*/
			...
			<script>
				...
				$( document ).ready(function() {
					...
					//$("#client_id").prepend("<option value=''></option>");
			...
			<li>
				...
				{!! Form::button('Convert into To Currency', array('id' => 'lkr_btn','class' => 'form_element')) !!}
			...
			<script>
				...
				$('#lkr_btn').click(function(){
					...
					var temp2=entered_to_currency_amount/sdr_to_lkr_rate;
			...
			<script>
				...
				jQuery("#sd_to_lkr").blur(function() {
					//alert("hello");
					var vals= $( "#sd_to_lkr" ).val();
					var driver_advance_element = document.getElementById('sd_to_lkr');
					if($.isNumeric(vals) && vals>=0){
