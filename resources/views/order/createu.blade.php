...
@section('middle_right_DIV')
		...
		<ul class="form_UL">
			...
			<li id="client_select">
				...
				{{ Form::label('client_id', 'Unknown Bank Account') }}
				<div>
				{{Form::select('client_id', $banks_ids,'',array('data-placeholder'=>'Choose a Client...','id'=>'client_id','class' => 'form_element','editable'=>'editable'))}}
				</div>
			</li>
