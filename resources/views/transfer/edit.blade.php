...
@section('middle_right_DIV')
			...
			<h4>Edit Giving</h4>
			{!! Form::open(array('route' => array('giving.update', $giving->id) ,'method' => 'PUT','files' => true)) !!}
		<ul class="form_UL">
			...
			<li>
				...
				{!!Form::select('agent_id', $agents,$giving->agent_id,array('id'=>'agent_id','class' => 'form_element'))!!}
			</li>
...
*/
			...
			<script>
				...
				$("#agent_id").change(function(){
					...
					jQuery.each(foods, function( index, value ) {
						...
						if(selected_site_id == index ){
							//alert( foods[selected_site_id][0]);
							// alert( foods[selected_site_id][1]);
							// alert( foods[selected_site_id][2]);
			 ...
			 <li>
		        ...
		        {!! Form::text('code',$giving->code,array('class' => 'form_element','id'=>'code')) !!}
		    </li>

			<li>
				{!! Form::label('date', 'Date') !!}
				{!! Form::text('date',$giving->date,array('class' => 'form_element','id'=>'date')) !!}
			...
			<li>
				...
				{!!Form::text('sdr',$giving->sdr,array('id'=>'sdr','class' => 'form_element'))!!}
			...
			<li>
				...
				{!!Form::text('lkr', $giving->lkr,array('id'=>'lkr','class' => 'form_element'))!!}
			...
			<li>
				...
				{!!Form::select('agent_bank_acc', $temp_agent_bank_accounts,$giving->agent_bank_acc,array('id'=>'agent_bank_acc','class' => 'form_element'))!!}
			</li>
			...
			<li>
				...
				{!! Form::textarea('note',$giving->note,array('class' => 'form_element')) !!}
			</li>
