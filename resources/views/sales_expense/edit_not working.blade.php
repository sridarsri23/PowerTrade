		...
		{!! Form::open(array('route' => array('order.update', $order->id) ,'method' => 'PUT','files' => true)) !!}
			<ul class="form_UL">
				...
				<li>
					...
					{!!Form::select('agent_id', $order->agent_id,'',array('id'=>'agent_id','class' => 'form_element'))!!}
				</li>
				...
				<li>
					...
					<div>
						{!!Form::select('client_id', $order->client_id,'',array('data-placeholder'=>'Choose a Client...','id'=>'client_id','class' => 'form_element'))!!}
					</div>
				</li>
				...
				<script>
					...
					$( document ).ready(function() {
						...
						var coder = <?php echo json_encode($order->code); ?>;
						var code_element = document.getElementById('code');
						default_site_code=sites_code[selected_site_id];
						default_company_code=companies_code[selected_company_id];
				...
				<li>
					...
					{!! Form::text('date','',array('class' => 'form_element','id'=>'date')) !!}
				...
				<li>
					...
					{!! Form::label('from_currency_amount', 'SDR Amount') !!}
				...
				<li>
					...
					{!! Form::label('to_currency_amount', 'LKR Amount') !!}
