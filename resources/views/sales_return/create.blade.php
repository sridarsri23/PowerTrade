...
@section('middle_right_DIV')
	...
	<script>
        ...
        $('#cash').focusout(function () {
			...
			var credit = (parseFloat(invoice_total) + total_prev_credit)-cash;
	...
	<script>
        ...
        $("#sales_id").change(function(){
            ...
            var salescode_routeid = <?php echo json_encode($salescode_routeid); ?>;
            var route_id_outlets_id = <?php echo json_encode($route_id_outlets_id); ?>;
            var outlets = <?php echo json_encode($outlets); ?>;
            var outlet_code = <?php echo json_encode($code); ?>;
            var selected_sales_id=$( "#sales_id" ).val();
            var code_element = document.getElementById('code');
            var temp=payments_code[selected_sales_id];
            //alert(temp);
            ...
            var selected_route_id =salescode_routeid[temp]
            $('#outlet_id').empty();
            $.each(route_id_outlets_id, function( outlet_id, route_id ) {
                if(selected_route_id == route_id) {


                            $('#outlet_id').append('<option value="' + outlet_id + '">' + outlets[outlet_id] + '</option>');
