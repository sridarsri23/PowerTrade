...
@section('middle_right_DIV')
	...
	<ul class="form_UL">
		...
		<li>
			{!! Form::hidden('is_resellable', 'No')!!}
			{!! Form::checkbox('is_resellable','Yes',true,array('class' => 'form_element','id' => 'is_resellable')) !!}


		</li>

		<li>
			{!! Form::hidden('is_sold', 'No')!!}
			{!! Form::label('is_sold', 'Is Sold?') !!}
			{!! Form::checkbox('is_sold','Yes',false,array('class' => 'form_element','id' => 'is_sold')) !!}
