...
@section('middle_right_DIV')
		...
		{!! Form::open(array('route' => 'sales.store','files' => true)) !!}
		<ul class="form_UL">
			<li>
			...
			<li>
				...
				{!!Form::select('lorry_id', $lorries,'',array('id'=>'lorry_id','class' => 'form_element'))!!}
			</li>

			<li>

				{!! Form::label('salesman_id', 'SalesMan') !!}
				{!!Form::select('salesman_id', $employees,'',array('id'=>'salesman_id','class' => 'form_element'))!!}
			</li>
			...
			<li>
				...
				{!!Form::select('driver_id', $drivers,'',array('id'=>'driver_id','class' => 'form_element'))!!}
			</li>

			<li>
				{!! Form::label('start_date', 'Start Date') !!}
				{!! Form::text('start_date',\Carbon\Carbon::now(),array('class' => 'form_element','id'=>'start_date')) !!}
			...
			<li>
				...
				{!! Form::text('end_date',\Carbon\Carbon::now(),array('class' => 'form_element','id'=>'end_date')) !!}
			</li>
			...
			@foreach ($productList as $index => $product)
				...
				<li>
					...
					{!! Form::text($product->code,$product->maximum_selling_price,array('class' => 'form_element','id'=>$product->code)) !!}
